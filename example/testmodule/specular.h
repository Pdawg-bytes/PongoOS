...
const Vector3 ideal_specular_reflect(const Vector3* d, 
											const Vector3* n) {
...
const Vector3 ideal_specular_transmit(const Vector3* d, 
											 const Vector3* n, 
											 double n_out, 
											 double n_in, 
											 double* pr, 
	...
	const Vector3 _b = mul_v3d(&nl, (nn * cos_theta + square_root(cos2_phi)));
